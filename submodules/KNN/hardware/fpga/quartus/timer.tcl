...
set_global_assignment -name PARTITION_NETLIST_TYPE POST_SYNTH -section_id "iob_knn:iob_knn_0"

set_global_assignment -name PARTITION_FITTER_PRESERVATION_LEVEL PLACEMENT_AND_ROUTING -section_id "iob_knn:iob_knn_0"

set_global_assignment -name PARTITION_COLOR 39423 -section_id "iob_knn:iob_knn_0"

set_instance_assignment -name PARTITION_HIERARCHY root_partition -to | -section_id Top

set_global_assignment -name LAST_QUARTUS_VERSION $QUARTUS_VERSION
set_global_assignment -name SDC_FILE ../knn.sdc
